defmodule DevSecRelAIWeb.Router do
  use DevSecRelAIWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {DevSecRelAIWeb.LayoutView, :root}
    plug :protect_from_forgery
    plug :put_secure_browser_headers
    plug DevSecRelAIWeb.RedirectPlug
    plug DevSecRelAIWeb.SetLocalePlug
  end
