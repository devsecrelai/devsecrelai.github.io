...
config :dev_sec_rel_ai,
  lesson_dir: "lessons",
  blog_dir: "posts/**/*.md",
  podcast_dir: "podcasts/*.md",
  conference_dir: "conferences/*.md"

# Configures the endpoint
config :dev_sec_rel_ai, DevSecRelAIWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "nkt+Wx4IwiwuGAAwhadih8PBxcacSurWEq1mWbLUEiRuA6s+Vtl075yHVnyhxWeV",
  render_errors: [view: DevSecRelAIWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: DevSecRelAI.PubSub,
...
# You should add locales here and in DevSecRelAI.LocaleInfo
config :dev_sec_rel_ai, DevSecRelAIWeb.Gettext,
  default_locale: "en",
